...
export const NAMED_REGIONS: Record<string, string[]> = {
  ...
  'mid-atlantic': ['US-NY', 'US-NJ', 'US-PA', 'US-DE', 'US-MD', 'US-VA', 'US-WV'],
  'mid atlantic': ['US-NY', 'US-NJ', 'US-PA', 'US-DE', 'US-MD', 'US-VA', 'US-WV'],
  'northeast':    ['US-MA', 'US-CT', 'US-RI', 'US-NH', 'US-ME', 'US-VT',
                   'US-NY', 'US-NJ', 'US-PA', 'US-DE', 'US-MD'],

  // ── South ──────────────────────────────────────────────────────────────────
  'southeast':  ['US-NC', 'US-SC', 'US-GA', 'US-FL', 'US-AL', 'US-MS', 'US-TN', 'US-KY'],
  'south east': ['US-NC', 'US-SC', 'US-GA', 'US-FL', 'US-AL', 'US-MS', 'US-TN', 'US-KY'],
  'south':      ['US-TX', 'US-OK', 'US-AR', 'US-LA',
                 'US-NC', 'US-SC', 'US-GA', 'US-FL', 'US-AL', 'US-MS', 'US-TN', 'US-KY'],
  'gulf coast': ['US-TX', 'US-LA', 'US-MS', 'US-AL', 'US-FL'],

  // ── Midwest ────────────────────────────────────────────────────────────────
  'midwest':      ['US-OH', 'US-IN', 'US-IL', 'US-MI', 'US-WI', 'US-MN',
                   'US-IA', 'US-MO', 'US-ND', 'US-SD', 'US-NE', 'US-KS'],
  'great plains': ['US-ND', 'US-SD', 'US-NE', 'US-KS', 'US-MN', 'US-IA', 'US-MO'],
  ...
  'west':           ['US-WA', 'US-OR', 'US-CA', 'US-NV', 'US-ID',
                     'US-MT', 'US-WY', 'US-CO', 'US-UT', 'US-AZ', 'US-NM'],
